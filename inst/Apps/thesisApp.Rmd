...
IDW_straight <- read.table("C:/Files/Documents/R/publicLibs/inst/extdata4/IDW/Straight1.txt", header = TRUE, stringsAsFactors = F)
...
IDW_drive <- read.table("C:/Files/Documents/R/publicLibs/inst/extdata4/IDW/Drive1.txt", header = TRUE, stringsAsFactors = F)
